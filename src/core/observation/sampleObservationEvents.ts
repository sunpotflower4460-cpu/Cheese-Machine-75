...
export const SAMPLE_OBSERVATION_EVENTS: ObservationInput[] = [
  {
    ...
    notes: 'Sample: linear particle track candidate',
  },
  {
    eventId: 'sample-002',
    ...
    notes: 'Sample: hot pixel cluster suspect',
  },
  {
    eventId: 'sample-003',
    ...
    notes: 'Sample: curved track – possibly magnetic field effect',
  },
  {
    eventId: 'sample-004',
    ...
    notes: 'Sample: worth a second look',
  },
  {
    eventId: 'sample-005',
    ...
    notes: 'Sample: strong particle track candidate – archive worthy',
  },
]
